$(document).ready(function () {
    ...
    var chart = new CanvasJS.Chart("firstChartContainer_"  + id, {
    ...
    function addData(data) {
        ...
        if (error) {
            $('#firstChartContainer_' + id).hide();
            $('#firstChartError_' + id).append('<span>' + error + '</span>').css('margin', '30px 0 50px');
        } else {
    ...
    $.getJSON('/first-chart/' + id, addData);
});
